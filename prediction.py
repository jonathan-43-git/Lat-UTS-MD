...
def main():
    st.title('Churn Model Deployment')  # buat judul streamlitnya
    
    # Add user input components for 10 features
    # input one by one
    
    age=st.number_input("age", 0, 100)
    gender=st.radio("gender", ["Male","Female"])  # radio ini artinya radio button
    ...
    # kalo datanya diinput kita mesti specify datatypesnya.
